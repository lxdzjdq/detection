...
sys.path.append(r"E:\Anaconda\envs\python3\Lib\site-packages\tensorflow\models\research\object_detection")
sys.path.append(r"E:\Anaconda\envs\python3\Lib\site-packages\tensorflow\models\research\slim")
sys.path.append(r"E:\Anaconda\envs\python3\Lib\site-packages\tensorflow\models\research")
...
#                     mask_type='png'
  ...
  with contextlib2.ExitStack() as tf_record_close_stack:
    ...
    #用TFRecordWriter来生成tfrecord文件，这样所有输出都会保存在一个文件中
...
def main(_):
  ...
  for imageName in os.listdir(image_dir): 
    #只取jpg格式图片
    if imageName[-4:]=='.jpg':
        examples_list.append(imageName[:-4])
